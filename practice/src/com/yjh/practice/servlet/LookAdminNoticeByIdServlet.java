...
@WebServlet("/LookAdminNoticeByIdServlet")
public class LookAdminNoticeByIdServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public LookAdminNoticeByIdServlet() {
        super();
    }
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//post解码方式
				...
				try {
					...
					request.getRequestDispatcher("/jsp/adminAnnuncement-detail.jsp").forward(request, response);
				}catch(Exception e) {
					//跳转到404页面,并打印错误信息
